...
cymbolLabelWithImage.addMouseListener(this);
...
JLabel cymbolClicked = (JLabel) e.getSource(); // This line gets the label
JLabel snareClicked = (JLabel) e.getSource(); // This line gets the label
												// that the mouse
														// clicked on
...
if(drumClicked == drumLabelWithImage) {
	...
	playSound("drunboop.wav");
}
if(cymbolClicked == cymbolLabelWithImage) {
	
	playSound("cymbol.wav");
}
if(snareClicked == snareLabelWithImage) {
